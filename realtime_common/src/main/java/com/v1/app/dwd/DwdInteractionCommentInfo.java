 ...
 * 1.从 Kafka 的 topic_db 主题读取数据库变更日志
 * 2.筛选出评论表(comment_info)的读取操作(op = 'r')
 * 3.与 HBase 中的字典表(base_dic)关联，获取评价等级的名称
 * 4.将处理后的数据写入 Kafka 的dwd_interaction_comment_info 主题
 */
...
public class DwdInteractionCommentInfo {
    public static void main(String[] args) throws Exception {
        ...
        tableEnv.executeSql("CREATE TAB `LE topic_db (\n" +
